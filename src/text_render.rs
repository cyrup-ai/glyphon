...
use cosmyc_text::{Color, SubpixelBin};
use wgpu::{
...
use crate::{
    ...
    TextArea, TextAtlas, Viewport, custom_glyph::CustomGlyphCacheKey,
};
...
impl TextRenderer {
    ...
    pub fn prepare_with_depth_and_custom<'a>(
        ...
        for text_area in text_areas {
            ...
            let is_run_visible = |run: &cosmyc_text::LayoutRun| {
